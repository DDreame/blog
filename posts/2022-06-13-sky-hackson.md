...
> 结果上的第一是机缘巧合，是收到了其他队伍的无私帮助，是组内成员的配合，并不是自身能力的突出。
...
感谢无辑队长（是的还是他）提供的视频链接，干货满满：[详解TensorRT的C++/Python高性能部署，实战应用到项目](https://www.bilibili.com/video/BV1Xw411f7FW)

一个高星的 GitHub 项目，欢迎大家阅读代码：[tensorrtx](https://github.com/wang-xinyu/tensorrtx)

官方TRT仓库:[TensorRT](https://github.com/NVIDIA/TensorRT)，内有官方 plugin。

官方 TensorRT 教程视频：[TensorRT 教程 | 基于 8.2.3 版本](https://www.bilibili.com/video/BV15Y4y1W73E/)。
