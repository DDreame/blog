---
title: 个人参加第六届Sky hackson比赛整体复盘
---
...
比赛一开始只是跑了基本的 jupyter notebook，随后陷入迷茫，对于TTS的优化（主要是去噪和生成效果两方面）止步不前，对于目标检测则存在数据集预处理、模型选择等多个问题。
...
> 模型部署方面个人理解较多，重点请看推荐阅读部分，环境部分偏向基础。
> - [数据收集与处理](#数据收集与处理)
>     - [ASR数据部分](#asr部分)
>     - [TTS数据部分](#tts部分)
>     - [目标检测部分](#目标检测数据集)
...
感谢**无辑**队长（是的还是他）提供的视频链接，干货满满：[详解TensorRT的C++/Python高性能部署，实战应用到项目](https://www.bilibili.com/video/BV1Xw411f7FW)

一个高星的 GitHub 项目，内含各种模型的TRT实现，经过验证都是基本可以直接使用的，欢迎大家Star：[tensorrtx](https://github.com/wang-xinyu/tensorrtx)

官方TRT仓库，带有官方plugin:[TensorRT](https://github.com/NVIDIA/TensorRT)，内有官方 plugin。
